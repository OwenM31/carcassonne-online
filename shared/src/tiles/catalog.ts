...
export const RIVER_TILE_CATALOG: TileCatalogEntry[] = [
  ...
  },
  {
    ...
    startingTileCandidate: false,
    features: {
      edges: edges(ROAD, FARM, RIVER, RIVER),
      cities: [],
      roads: [road(['N'])],
      farms: [farmCorners(['NE', 'SE']), farmCorners(['NW']), farmCorners(['SW'])],
      monastery: false
    }
  },
  {
  ...
  },
  {
    ...
    features: {
      ...
      cities: [],
      roads: [road(['S'])],
      farms: [farmCorners(['NW']), farmCorners(['NE']), farmCorners(['SE', 'SW'])],
      monastery: true
    }
  },
  {
...
export const RIVER_2_TILE_CATALOG: TileCatalogEntry[] = [
  ...
  },
  {
    ...
    features: {
      ...
      cities: [],
      roads: [],
      farms: [farmCorners(['NW', 'SW', 'SE']), farmCorners(['NE'])],
      monastery: false
    }
  },
  {
  ...
  },
  {
    ...
    features: {
      ...
      roads: [road(['N'])],
      farms: [
        farmZones(['NNW', 'WNW', 'WSW']),
        farmZones(['NNE', 'ENE', 'ESE'])
      ],
      monastery: false
    }
  },
